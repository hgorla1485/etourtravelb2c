...
import com.etourtravelb2b.storefront.controllers.ControllerConstants;
import com.etourtravelb2b.storefront.forms.Etourtravelb2bUpdateProfileForm;
import com.etourtravelb2b.storefront.forms.validator.Etourtravelb2bProfileUpdateValidator;
...
public class AccountPageController extends AbstractSearchPageController
{
	...
	@Resource(name = "etourtravelb2bProfileValidator")
	private Etourtravelb2bProfileUpdateValidator etourtravelb2bProfileValidator;
	...
	protected Etourtravelb2bProfileUpdateValidator getProfileValidator()
	{
		return etourtravelb2bProfileValidator;
	}
	...
	public String editProfile(final Model model) throws CMSItemNotFoundException
	{
		...
		final Etourtravelb2bUpdateProfileForm updateProfileForm = new Etourtravelb2bUpdateProfileForm();
		System.out.println("before existing data" + customerData.getContactNumber());
		System.out.println("Before existing data" + customerData.getCurrentLocation());
		...
		model.addAttribute("etourtravelb2bUpdateProfileForm", updateProfileForm);
	...
	@RequireHardLogIn
	public String updateProfile(final Etourtravelb2bUpdateProfileForm updateProfileForm, final BindingResult bindingResult,
			final Model model, final RedirectAttributes redirectAttributes) throws CMSItemNotFoundException
	{
		...
		System.out.println("formdata" + updateProfileForm.getContactNumber());
		System.out.println("formdata" + updateProfileForm.getCurrentLocation());

		currentCustomerData.setTitleCode(updateProfileForm.getTitleCode());
		...
		currentCustomerData.setContactNumber(updateProfileForm.getContactNumber());
		currentCustomerData.setCurrentLocation(updateProfileForm.getCurrentLocation());
		/*
		...
		else
		{
			try
			{
				customerFacade.updateProfile(currentCustomerData);
				GlobalMessages.addFlashMessage(redirectAttributes, GlobalMessages.CONF_MESSAGES_HOLDER,
						"text.account.profile.confirmationUpdated", null);

...
public class ProductPageController extends AbstractPageController
{
			...
			UnsupportedEncodingException
	{
		...
		/*
		 * if (productModel instanceof Etourtravelb2bDaysVariantProductModel) { // final Map<String, Boolean> allAddonsMap =
		 * new HashMap<String, Boolean>(); final List addonsList = new ArrayList();
		 * addonsList.add(((Etourtravelb2bDaysVariantProductModel) productModel).getAddons());
		 *
		 * model.addAttribute("addonsList", addonsList);
		 *
		 * }
		 */
		...
		list.add(productModel.getProductRating());
		list.add(productModel.getProductCustomerSatisfaction());

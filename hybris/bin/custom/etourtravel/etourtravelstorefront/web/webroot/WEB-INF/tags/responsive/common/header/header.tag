		...
		<div class="container">
				...
				<div class="col-sm-12 col-md-8">
					<div class="md-secondary-navigation">
						...
						<ul>
							...
							<%-- 	<li>
									<div class="container accNavComponent" style="display:none;" data-title="My Account"> 
			...
			<nav style="display:none;"> 
				<ul>
					...
					<div>
							<div>
									<a href="/etourtravelb2bstorefront/en/my-account/update-profile" title="Personal Details">Personal Details</a></div>
							</div>
					<div>
							<div>
									<a href="/etourtravelb2bstorefront/en/my-account/update-email" title="Email Address">Email Address</a></div>
							</div>
					<div>
							<div>
									<a href="/etourtravelb2bstorefront/en/my-account/payment-details" title="Payment Details">Payment Details</a></div>
							</div>
					<div>
							<div>
									<a href="/etourtravelb2bstorefront/en/my-account/update-password" title="Password">Password</a></div>
							</div>
					<div>
							<div>
									<a href="/etourtravelb2bstorefront/en/my-account/orders" title="Order History">Order History</a></div>
							</div>
					<div>
							<div>
									<a href="/etourtravelb2bstorefront/en/my-account/address-book" title="Address Book">Address Book</a></div>
							</div>
					<div>
							<div>
									<a href="/etourtravelb2bstorefront/en/my-account/support-tickets" title="Support Tickets">Support Tickets</a></div>
							</div>
					</ul>
			</nav>
		</div>

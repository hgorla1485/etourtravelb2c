...
<div id="header" class="clearfix">
	...
	<div class="headerContent ">
		...
		<%-- 	<li><ycommerce:testId code="header_ComingSoon"><a href="<c:url value="/coming-soon/products"/>" target="_blank"><spring:theme code="header.link.ComingSoon" text="Coming Soon"/></a></ycommerce:testId></li>
			 --%>
			</c:if>

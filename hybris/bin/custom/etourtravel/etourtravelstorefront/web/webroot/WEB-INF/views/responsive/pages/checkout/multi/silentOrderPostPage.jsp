...
<div class="row">
    ...
    <%--Voucher related code for etourtravelb2b........ --%>
<div id="redeem" style="display: block">
	...
	<%-- <div id="release" style="display: block">		
		<c:url value="/checkout/voucher/release" var="releaseVoucherURl"/>
			<form action="${releaseVoucherURl}" method="GET">
			Voucher Code Release : 
				<input type="submit" value="Release" onclick="onRelease()" />
			<b ><font color="red">${param.Message}</font></b> 
			</form>
			<br>	
	</div> --%>
	...
	function onRelease() {
 	...
 	<%--Voucher related code for etourtravelb2b ended..... --%>

...
import com.etourtravelb2b.jalo.ProductQuantityThresholdFreeGiftPromotion;
...
/**
 * Generated class for type <code>Etourtravelb2bcommerceservicesManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedEtourtravelb2bcommerceservicesManager extends Extension
{
	...
	public ProductQuantityThresholdFreeGiftPromotion createProductQuantityThresholdFreeGiftPromotion(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( Etourtravelb2bcommerceservicesConstants.TC.PRODUCTQUANTITYTHRESHOLDFREEGIFTPROMOTION );
	...
	{
		return Etourtravelb2bcommerceservicesConstants.EXTENSIONNAME;
	}

 ...
 *  
 */
package com.etourtravelb2b.jalo;
...
import com.etourtravelb2b.constants.Etourtravelb2bcommerceservicesConstants;



/**
 * This is the extension manager of the Etourtravelb2bcommerceservices extension.
 */
public class Etourtravelb2bcommerceservicesManager extends GeneratedEtourtravelb2bcommerceservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Etourtravelb2bcommerceservicesManager.class.getName());
	 ...
	 */
	public static Etourtravelb2bcommerceservicesManager getInstance()
	{
		return (Etourtravelb2bcommerceservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Etourtravelb2bcommerceservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Etourtravelb2bcommerceservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Etourtravelb2bcommerceservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Etourtravelb2bcommerceservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Etourtravelb2bcommerceservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
